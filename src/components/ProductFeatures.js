    ...
    <section className="product-features">
      ...
      <div className="core-features">
        <div className="core-feature-1">
          ...
          <p>
            You can use almost all actions of github actions as your Actionsflow
            jobs to handle a complex workflow
          </p>
        </div>
        <div className="core-feature-3">
          ...
          <p>
            You can easily set a webhook URL at 3rd party service, then receive
            the webhook event at triggers
          </p>
        </div>
        <div className="core-feature-2">
          ...
          <h2>
            <a href="https://actionsflow.github.io/docs/workflow/">
              Easy for Writing Workflow File
            </a>
          </h2>
          <p>
            Actionsflow configuration format is the same as Github actions, it's
            really easy for you to define an Actionsflow workflow file
          </p>
        </div>
      </div>
    </section>
